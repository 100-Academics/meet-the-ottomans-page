...
export class ItalianSoldier extends npc {
    private readonly meleeRange = 2.3;
    private readonly meleeDamage = 16;
    private readonly meleeCooldownSeconds = 4.5;
    private readonly meleeWindupSeconds = 0.45;

    private readonly rangedRange = 30;
    private readonly rangedDamage = 12;
    private readonly rangedCooldownSeconds = 1.6;
    private readonly rangedProjectileSpeed = 70;

    private lastRangedAttackTime = -Infinity;
    private meleeWindupPending = false;

    constructor(id: number, modelEntity: Entity = new Entity("italian soldier")) {
        ...
        this.aiConfig.detectionRange = 40;
    }
    ...
    private fireProjectileAt(
        ...
        const projectile = new Entity("italian bullet");
        projectile.setPosition(origin);
        projectile.lookAt(origin.clone().add(dir));

        const tracer = new Entity("italian bullet tracer");
